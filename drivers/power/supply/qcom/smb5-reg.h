...
#define CHARGER_ERROR_STATUS_BAT_MISSING_BIT	BIT(0)
...
#define SOC_BASED                               BIT(1) //ASUS_BSP

#define PRE_CHARGE_CURRENT_CFG_REG		(CHGR_BASE + 0x60) //ASUS_BSP
#define PRE_CHARGE_CURRENT_SETTING_MASK		GENMASK(2, 0) //ASUS_BSP

#define CHGR_FAST_CHARGE_CURRENT_CFG_REG	(CHGR_BASE + 0x61)
#define CHGR_FAST_CHARGE_CURRENT_SETTING_MASK	GENMASK(7, 0) //ASUS_BSP

#define TCCC_CHARGE_CURRENT_TERMINATION_CFG_REG	(CHGR_BASE + 0x63) //ASUS_BSP
#define TCCC_CHARGE_CURRENT_TERMINATION_SETTING_MASK	GENMASK(3, 0) //ASUS_BSP
...
#define JEITA_FVCOMP_CFG_HOT_REG		(CHGR_BASE + 0x91) //ASUS_BSP
#define JEITA_CCCOMP_CFG_HOT_REG		(CHGR_BASE + 0x92)
#define JEITA_CCCOMP_CFG_COLD_REG		(CHGR_BASE + 0x93)
#define JEITA_FVCOMP_CFG_COLD_REG		(CHGR_BASE + 0x86) //ASUS_BSP
...
#define DCDC_OTG_CURRENT_LIMIT_MASK		GENMASK(2, 0) //ASUS_BSP
...
#define HVDCP_PULSE_COUNT_MAX_QC3_MASK         GENMASK(5, 0) //ASUS_BSP
enum {
...
#define USBIN_CURRENT_LIMIT_MASK		GENMASK(7, 0) //ASUS_BSP
...
#define TYPEC_LEGACY_CABLE_TYPE_MASK			GENMASK(1, 0) //ASUS_BSP
...
//ASUS_BSP +++
#define TYPE_C_LEGACY_CABLE_CFG_REG		(TYPEC_BASE + 0x5A)
...
#define THERMREG_INOV_ENABLE			GENMASK(2, 0) //ASUS_BSP
