...
if(g_ASUS_hwID == HW_REV_EVB){
	...
	printk("[FTS][touch] %s: this is SR skip init\n", __func__);
}
    FTS_FUNC_EXIT();
    return 0;
...
if(g_ASUS_hwID == HW_REV_EVB){
	...
	printk("[FTS][touch] %s: this is SR skip release\n", __func__);
}
    return 0;
}
...
if(g_ASUS_hwID == HW_REV_EVB){
	...
	printk("[FTS][touch] %s: this is SR skip lab idd\n", __func__);
}
    FTS_FUNC_EXIT();
    return ret;
}
